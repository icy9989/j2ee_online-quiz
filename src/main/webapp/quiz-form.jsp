        ...
        <div class="bg-white mx-5 text-center center-block col-10 mx-auto card">
          	<form action="question-form" method="post">
            	...
            	<div class="col-9 mx-auto">
              		...
              		<div class="form-group row mb-3">
                		<label class="col-sm-2 col-form-label text-center textprimarys">Duration (minute)</label>
                		<div class="col-sm-8">
                  			<input type="number" class="form-control text-secondary" id="duration" name="duration" min="1" oninput="validity.valid||(value='');" autocomplete="off" required/>

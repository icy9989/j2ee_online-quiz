...
<body>
						...
						<div class="col-xl-2 col-lg-3 col-md-5 fixed-top sidebars">
							...
							<ul class="mt-5 lists">
								<li class="listitems dashboards actives"><a
									href="admin-dashboard"><i class="fas fa-home mx-3"></i>Dashboard</a></li>
								<li class="listitems students"><a href="#"><i
										class="fas fa-user-graduate mx-3"></i>Students</a></li>
								<li class="listitems instructors"><a href="#"><i
										class="fas fa-chalkboard-teacher mx-3"></i>Intstructors</a></li>
	...
	<section class="container-fluid">
		...
		<div class="row">
			...
			<!-- Start Instructor -->
			<div id="instructor" class="col-xl-7 col-lg-5 col-sm-7 ms-auto p-4">
				<p class="fw-bold text-secondary text-uppercase">Instructor</p>
				<div class="row">
					<div class="col-xl-6 px-5 my-3 newcards">
						<a href="instructor">
							<div class="card px-4">
						...
						<form action="ChangePassword" method="post">
							<div class="p-3">
								<input type="hidden" name="user_id"
									...
									name="role" value="<c:out value='${role}' />" /> <input
									type="hidden" name="pw" value="<c:out value='${password}' />" />
	...
	<script src="http://localhost:8080/online_quiz/js/app.js"
		type="text/javascript"></script>
	<script src="http://localhost:8080/online_quiz/js/admin-dashboard.js"
		type="text/javascript"></script>
